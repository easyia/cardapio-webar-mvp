    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fade-in">
      ...
      >
        ...
        <div className="text-center mb-6">
          <div className="inline-flex p-3 rounded-2xl bg-orange-500/10 border border-orange-500/30 text-orange-400 mb-3 shadow-inner">
          ...
          <p className="text-xs text-slate-400 mt-1 max-w-xs mx-auto">
            Projete o <strong className="text-orange-300 font-semibold">{dish.name}</strong> em tamanho real 1:1 na sua mesa agora mesmo!
          </p>
        </div>

        {/* QR Code Card */}
        <div className="bg-white p-4 rounded-2xl shadow-xl flex flex-col items-center justify-center mx-auto max-w-[220px] border-4 border-orange-500/20">
          <QRCodeSVG
            value={directARUrl}
            size={180}
            level="H"
          ...
          />
          <div className="flex items-center gap-1.5 mt-2 text-[11px] font-bold text-slate-800">
        ...
        {/* Instructions Steps */}
        <div className="mt-6 space-y-2.5 bg-slate-950/60 rounded-2xl p-4 border border-slate-800/80">
          <div className="flex items-start gap-3">
            ...
            <p className="text-xs text-slate-300">Abra a câmera do seu smartphone (iPhone ou Android) e aponte para o QR Code acima.</p>
          </div>
          <div className="flex items-start gap-3">
            ...
            <p className="text-xs text-slate-300">Toque na notificação amarela que aparecer para abrir no navegador.</p>
          </div>
          <div className="flex items-start gap-3">
            ...
            <p className="text-xs text-slate-300">Aponte a câmera para a mesa e veja o prato renderizado em escala exata!</p>
          </div>
        </div>
